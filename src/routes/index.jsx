...
const RecoverPassword = lazy(() =>
    import("@/app/(other)/auth/recover-password/page")
);
const CreatePassword = lazy(() =>
    import("@/app/(other)/auth/create-password/page")
);
...
const SweetAlert = lazy(() =>
    import("@/app/(admin)/extended/sweet-alert/page")
);
...
const CandlestickCharts = lazy(() =>
    import("@/app/(admin)/charts/candlestick/page")
);
...
const DataTables = lazy(() =>
    import("@/app/(admin)/tables/datatable-tables/page")
);
...
const ViewInvoices = lazy(() =>
    import("@/app/(admin)/invoices/view-invoice/page")
);
const CreateInvoices = lazy(() =>
    import("@/app/(admin)/invoices/create-invoice/page")
);
...
const ServiceUnavailable = lazy(() =>
    import("@/app/(other)/errors/service-unavailable/page")
);
...
const FullScreenView = lazy(() =>
    import("@/app/(other)/layouts/fullscreen-view/page")
);
...
const CreateProfessional = lazy(() => import("@/app/(professionals)/apps/Create/page"));
